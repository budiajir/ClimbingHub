    ...
    sectors: [
        ...
        problems: [
          {
            ...
            pitchLength: '24m',
            boltCount: 9,
            anchorType: 'Double Ring Chain Anchor',
            setter: 'Andi Wahyu',
            fa: 'Rizky Fauzan',
            faDate: '2019-03-15',
            description: 'Jalur sport single pitch bertali di dinding karst Goa Pawon. Crux di bolt ke-4 melewati overhang tipis dan undercling kapur.',
            ...
            ascentCount: 89,
            gradeVotes: [
              { grade: '5.10c', votes: 12 },
              { grade: '5.10d', votes: 45 },
              { grade: '5.11a', votes: 18 },
            ],
            markers: [
      ...
      },
      {
        ...
        problems: [
          ...
          {
            id: 'citatah-b-2',
            name: 'Tebing 125 Central Pillar',
            discipline: 'sport',
            grade: '5.11b',
            fontGrade: '6c',
            pitchLength: '32m',
            boltCount: 12,
            anchorType: 'Twin Stainless Rings',
            setter: 'FPTI Jabar',
            fa: 'Tim FPTI (2018)',
            faDate: '2018-06-10',
            description: 'Single pitch sport climbing vertikal setinggi 32 meter di pilar utama Tebing 125. Crimp endurance intensif.',
            accessInfo: 'Basecamp Tebing 125 Padalarang',
            localContact: 'Pak Dede: +6285678901234',
            ascentCount: 41,
            gradeVotes: [
              { grade: '5.11a', votes: 10 },
              { grade: '5.11b', votes: 24 },
            ],
            markers: [
        ...
        problems: [
          {
            ...
            totalHeight: '165m',
            pitchBreakdown: [
              { pitchNumber: 1, grade: '5.9 (5c)', length: '40m', description: 'Slab friction awal menyusuri retakan granit menuju teras anchor pertama.' },
              { pitchNumber: 2, grade: '5.11a (6c+)', length: '35m', description: 'Crux pitch: dihedron corner tipis dengan finger jam dan layback menantang.' },
              { pitchNumber: 3, grade: '5.10b (6a+)', length: '45m', description: 'Face climbing vertical dengan pocket kristal granit merah.' },
              { pitchNumber: 4, grade: '5.10a (6a)', length: '45m', description: 'Mantle finish melewati lip dinding atas menuju stasiun puncak.' },
            ],
            descentInfo: 'Rapel 4 kali dari anchor stasiun berantai resmi dengan tali ganda 2x60m. Wajib gunakan helmet dan prusik backup.',
            setter: 'Ekspedisi Indonesia-Prancis',
            fa: 'Pierre & Mak Etek (2017)',
            faDate: '2017-08-17',
            description: 'Rute multi-pitch mahakarya di tebing granit Lembah Harau. Menawarkan sensasi pemanjatan dinding tinggi dengan panorama persawahan Minangkabau.',
            ...
            gradeVotes: [
              { grade: '5.10d', votes: 5 },
              { grade: '5.11a', votes: 19 },
              { grade: '5.11b', votes: 4 },
            ],
            markers: [
              { id: 'mh-start', type: 'S', x: 45, y: 92, label: 'S' },
              { id: 'mh-p1', type: 'P', x: 47, y: 72, label: 'P1' },
              { id: 'mh-p2', type: 'P', x: 50, y: 52, label: 'P2' },
              { id: 'mh-p3', type: 'P', x: 53, y: 32, label: 'P3' },
          ...
          },
          {
            ...
            pitchLength: '28m',
            boltCount: 11,
            anchorType: 'M12 Marine Chain Anchor',
            setter: 'Doni Pratama',
            fa: 'Doni Pratama (2020)',
            faDate: '2020-09-12',
            description: 'Single pitch sport climbing dengan crimp kristal mikro di granit licin. Sangat menguji daya tahan jari.',
            accessInfo: 'Dasar tebing Echo Valley',
            localContact: 'Mak Etek: +6281345678901',
            ascentCount: 19,
            gradeVotes: [
              { grade: '5.11d', votes: 6 },
              { grade: '5.12a', votes: 13 },
            ],
            markers: [
    ...
    sectors: [
      {
        ...
        problems: [
          ...
          },
          {
            ...
            pitchLength: '18m',
            boltCount: 7,
            anchorType: 'Marine Stainless Anchor',
            setter: 'FPTI DIY',
            fa: 'Tim FPTI (2015)',
            faDate: '2015-04-12',
            description: 'Single pitch sport tebing karst dengan pocket tajam dan pegangan jug bersahabat untuk pemanjat menengah.',
            accessInfo: 'Tebing sisi barat Pantai Siung',
            localContact: 'Mas Danang: +6285678901234',
            ascentCount: 115,
            gradeVotes: [
              { grade: '5.10a', votes: 20 },
              { grade: '5.10b', votes: 85 },
              { grade: '5.10c', votes: 10 },
            ],
            markers: [
