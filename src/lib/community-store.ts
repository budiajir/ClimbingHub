  ...
  "comm-1": [
    {
      ...
      caption: "Saturday morning bouldering session with the crew at Vertigo! Finally sent the dyno crux 🎉",
    ...
    },
    {
      ...
      caption: "Outdoor crag trip to Citatah 90. Clear skies, crisp rock friction, pure psyche all day!",
    ...
    },
    {
      ...
      caption: "Route setter workshop: setting fresh V5 boulder problems for the internal community comp.",
  ...
  "comm-2": [
    {
      ...
      caption: "Mastering precision heel & toe hooks on the steep overhang wall at Crux Bandung.",
    ...
    },
    {
      ...
      caption: "Squad gathering after our climb session. Gearing up for the Harau crag expedition next month!",
  ...
  "comm-3": [
    {
      ...
      caption: "Ocean-side bouldering at Pantai Siung. Nothing beats the sound of waves crashing below sharp limestone.",
    ...
    },
    {
      ...
      caption: "Sunset send session at Siung. Golden hour vibes with Jogja climbers!",
